...
void setup1() {
  ...
  pwmController.setChannelPWM( 0, 2000); // centre bias output (no current limit resistor)
  
  pwmController.setChannelPWM( 1, 2048); // Set PWM to mid range
  pwmController.setChannelPWM( 2, 2048); // Set PWM to mid range
  pwmController.setChannelPWM( 3, 2048); // Set PWM to mid range
 
  pwmController.setChannelPWM( 5, 4095); // Set PWM to full on
  pwmController.setChannelPWM( 6, 4095); // Set PWM to full on

  pwmController.setChannelPWM( 8, 4095); // Set PWM to full on
  pwmController.setChannelPWM( 9, 4095); // Set PWM to full on
  pwmController.setChannelPWM(10, 4095); // Set PWM to full on
...
void loop1() {
  ...
  if(target2_time % 250L == 0)
  {
    ...
    ARINC_value = heading * 100;
//    ARINC_value = frequency1 * 100;
...
//    draw_needle(angle);   // draw meter pointer
    draw_needle(heading);   // draw meter pointer
  }
